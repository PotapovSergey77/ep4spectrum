...
Демка **Across** — многоцветная картинка и бордюр, нарисованные счётом
тактов процессора, то есть ровно то, что эти четыре величины и задают:

![Across: многоцветная картинка](images/IMG_3046.jpeg)

![Across: многоцветный бордюр](images/IMG_3051.jpeg)
...
- **У +2A/+3 нет своей страничной памяти.** Регистр `$1FFD` и особые
  режимы «вся память ОЗУ» не реализованы: их код был написан под выбор
  машины на этапе сборки, а машину здесь выбирают на ходу, и синтезатор
  эти ветви никогда не строил. Обнаружилось не чтением кода, а его
  предупреждениями. Тайминги и растр у +2A/+3 при этом свои и работают;
  не работает только его собственная страничная память.
